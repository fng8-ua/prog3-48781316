...
public class Fighter_prac2 {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Fighter_prac2 other = (Fighter_prac2) obj;
	 ...
	 */
	Fighter_prac2(String type, Ship mother) {
		this.type = type;
		id = nextId;
		motherShip = mother;
	 ...
	 * @param f the f
	 */
	public Fighter_prac2(Fighter_prac2 f) {
		type = f.type;
		id = f.id;
		velocity = f.velocity;
		attack = f.attack;
	 ...
	 */
	public int getDamage(int n, Fighter_prac2 enemy) {
		int damage;
	 ...
	 */
	public int fight(Fighter_prac2 enemy) {
